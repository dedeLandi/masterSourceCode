...
public class MappingArchitectureElements {
	...
	protected void createContents() {
		this.TOBE = this.readingKDMFile.load("file:C:/TestsPlug-in/archKDM/planned.xmi");
		this.ASIS = this.readingKDMFile.load("file:C:/TestsPlug-in/archKDM/newKDM.xmi");
		...
		btnGenerate.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				readingKDMFile.save(ASIS, "file:C:/TestsPlug-in/archKDM/newKDM2.xmi");
			}
		});
